...
public class HuffmanDecode {
    ...
    public static void decode(){
        ...
        String text="";
        try{
            FileInputStream is =new FileInputStream("src/main/java/org/example/end.Huffman.txt");
        ...
        try{                                 //reading File.table and recreating Huffman Tree
            reader =new FileReader("src/main/java/org/example/end.table.txt");
        ...
        try {
            PrintWriter zapis = new PrintWriter("src/main/java/org/example/End.txt");
            zapis.println(text);
            zapis.close();
